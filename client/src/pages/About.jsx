            ...
            <section className="relative pt-28 pb-20 px-4 overflow-hidden">
                ...
                <div className="max-w-4xl mx-auto text-center relative z-10">
                    ...
                    <h1 className="text-4xl md:text-5xl lg:text-6xl font-extrabold text-gray-900 mb-6 tracking-tight">
                        Về <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary-600 to-primary-400">Hương Thảo Trà</span>
                    </h1>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
                        <div>
                            ...
                            <p className="text-gray-600 mb-6 text-lg font-medium leading-relaxed">
                                Tại Hương Thảo Trà, sứ mệnh của chúng tôi là cách mạng hóa cách mọi người tiếp cận sức khỏe tự nhiên.
